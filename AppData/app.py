...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/ModelSaving_Test_14/master/AppData/prepared_data.csv')
...
# User defined values
title = 'App'
encoder_location = 'https://github.com/karthikreddykuna/ModelSaving_Test_14/blob/master/AppData/encoder.pkl?raw=true'
